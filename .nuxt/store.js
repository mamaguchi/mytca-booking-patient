...
(function updateModules () {
  ...
  resolveStoreModules(require('../store/booking/actions.js'), 'booking/actions.js')
  resolveStoreModules(require('../store/booking/getters.js'), 'booking/getters.js')
  resolveStoreModules(require('../store/booking/mutations.js'), 'booking/mutations.js')
  resolveStoreModules(require('../store/booking/state.js'), 'booking/state.js')
  ...
  if (process.client && module.hot) {
    ...
    module.hot.accept([
      ...
      '../store/auth/state.js',
      '../store/booking/actions.js',
      '../store/booking/getters.js',
      '../store/booking/mutations.js',
      '../store/booking/state.js',
    ], () => {
